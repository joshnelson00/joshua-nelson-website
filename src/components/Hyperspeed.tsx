  ...
  useEffect(() => {
    ...
    const options: HyperspeedOptions = { 
      ...
      colors: {
        ...
        // Dark theme colors that match the site's aesthetic
        roadColor: 0x12121b,         // Very dark blue/black
        islandColor: 0x12121b,       // Slightly lighter than road
        background: 0x050508,        // Almost black background
        // Accent colors with teal added
        shoulderLines: 0x0ea5e9,     // Sky blue-500
        brokenLines: 0x22d3ee,       // Cyan-400
        // Car colors with teal variants
        leftCars: [
          0x8b5cf6,  // Indigo-500
          0x7c3aed,  // Indigo-600
          0x6d28d9,  // Purple-700
          0x14b8a6   // Teal-500 (added teal variant)
        ],
        rightCars: [
          0x3b82f6,  // Blue-500
          0x2563eb,  // Blue-600
          0x1d4ed8,  // Blue-700
          0x0d9488   // Teal-600 (added teal variant)
        ],
        // Light sticks/accents with teal
        sticks: 0x0d9488,            // Teal-600
      }
    };

    // Ensure we have a valid distortion
    if (typeof options.distortion === 'string') {
      const distortionKey = options.distortion as keyof typeof distortions;
      if (distortions[distortionKey]) {
        options.distortion = distortions[distortionKey];
      } else {
        console.warn(`Invalid distortion type: ${options.distortion}, using default`);
